...
/***************************************
@Author:Zhao YinFa
@Time: Created on 2017-11-7  11：40
@Function: 测试Opencv自带SURF算子的拼接效果
(1)特征点提取和匹配
(2)图像配准
(3)图像拷贝
(4)图像融合
...
//int main()
//{
//    Mat image1 = imread("/home/260158/code/Haikang/pictures/park1.jpg");
//    Mat image2 = imread("/home/260158/code/Haikang/pictures/park2.jpg");

//    /*(1)特征点提取和匹配*/
//    //提取特征点
//    SurfFeatureDetector Detector(2000);  //阈值
...
//    imshow("直接经过透视变换矩阵",imageTransform1);
//    imwrite("trans1.jpg", imageTransform1);

//    /*（3）图像拷贝*/
//    //创建拼接后的图，需提前计算图的大小
//    int dst_width = imageTransform1.cols;  //取最又点的长度为拼接图的长度
